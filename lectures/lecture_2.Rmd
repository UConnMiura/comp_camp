---
title: \sf Short read RNA-Seq analysis
header-includes:
- \usepackage{color}
- \usepackage{float}
...
For more on the usefuless of re-analyzing RNA-Seq data as a tool for learning and discovery, see this [article](https://doi.org/10.1016/j.molcel.2013.01.031) by our department chair Brent Graveley.
