---
title: \sf RNA-Seq analysis (short read)
header-includes:
- \usepackage{color}
- \usepackage{float}
...
### Conda
In order to install `deeptools` on the HPC, we will use conda. In order to learn how to use conda for installation purposes, go [TO BE PROVIDED].

Here's the slurm script for using `deeptools`. 
